...
@Component
public class ChooseScheduleAllAssembler implements RepresentationModelAssembler<ScheduleDTO, EntityModel<ScheduleDTO>> {

    @Override
    public EntityModel<ScheduleDTO> toModel(ScheduleDTO entity) {
        return EntityModel.of(entity
//                linkTo(methodOn(ApiController.class).chooseSchedule())
        );
    }
}
